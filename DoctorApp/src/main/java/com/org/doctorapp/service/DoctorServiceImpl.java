...
import com.org.doctorapp.repository.DoctorRepositoryImpl;
import com.org.doctorapp.repository.IDoctorRepository;
...
public class DoctorServiceImpl implements IDoctorService {
    ...
    @Override
    public Doctor getById(int doctorId) throws IdNotFoundExcetion {
        Doctor doctor = doctorRepository.findById(doctorId);
        if(doctor==null) {
            throw new IdNotFoundExcetion("Invalid ID");
        }
        return doctor;
    }
